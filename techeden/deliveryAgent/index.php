...
<body style="background-color: var(--primary);">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active" id="active">
                    <a id="navlink" class="nav-link" href="#">Delivery Agent</a>
                </li>
    ...
    <div class="row">
    <div id="maincontainer" style="width: 100%;padding-right:0;">
        <div id="tooltip">
            <?php
        ...
        <div class="container-fluid row" style="margin: 0;padding:0;">
                <?php
                if (!isset($_SESSION['logged'])) {
                    echo '<h2 style="margin:30vh auto;">Please Login to view your Delivery tasks.';
                } else {
                    echo '
                    
                    <div class="events" style="width:100%;padding-top:10px;">
                        <h3 style="margin: 0;">Delivery Details</h3><hr>
                        <div id="map"></div>
                        
                        <div id="acceptRequestStatus"></div>
                        <ul class="events-list row" id="deliveryTasksList" style="width:100%;margin:0;">
