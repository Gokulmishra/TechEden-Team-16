...
<body>
    ...
    <div id="maincontainer" class="col-md-9 ml-sm-auto col-lg-10" style="width: 100%;padding-right:0;">
        ...
        <div class="container-fluid row" style="margin: 0;">
            <div class="app row">
                ...
                <?php
                if (!isset($_SESSION['logged'])) {
                    echo '<h2 style="margin:30vh auto;">Please Login to view your accepted requests.';
                } else {
                    echo '
                    
                    <div class="events" style="width:100%;">
                        <h3 style="margin: 0;">Accepted Requests</h3><hr>
                        <div id="map"></div>
                        
                        <div id="acceptRequestStatus"></div>
                        <ul class="events-list row" id="acceptedRequestList">
    ...
    <script src="acceptedScripts.js"></script>
